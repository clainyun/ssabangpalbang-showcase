...
public final class CommentUpdateRequestDeserializer
        extends StdDeserializer<CommentUpdateRequest> {

    public CommentUpdateRequestDeserializer() {
        super(CommentUpdateRequest.class);
    }

    @Override
    public CommentUpdateRequest deserialize(
            JsonParser parser,
